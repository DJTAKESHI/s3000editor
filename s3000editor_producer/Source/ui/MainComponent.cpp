...
// ========================================
    ...
    case 0x28:
    {
        ...
        // ==============================
        // Update Program Editor on UI thread
        // ==============================
        ...
        DBG("PROGRAM EDITOR SET FROM PROGRAM HEADER");
...
//            );
    ...
    case 0x2A:
    {
        ...
        if (currentKeygroup >= loadedProgram.keygroups.size())
        {
            loadedProgram.keygroups.resize(
                currentKeygroup + 1
            );
